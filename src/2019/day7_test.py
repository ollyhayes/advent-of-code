...
def test_part_1(program: str, sequence: List[int], expected: List[int]) -> None:
	assert compute_output_signal_part_1(program, sequence) == expected
...
def test_part_2(program: str, sequence: List[int], expected: List[int]) -> None:
	assert compute_output_signal_part_2(program, sequence) == expected